          ...
          return (
            <React.Fragment key={settlement.id}>
              ...
              <MunicipalityDemo
                id={settlement.id}
                title={settlement.title}
                image={settlement.image_main}
                properties={getProperties(settlement)}
                isMobile={true}
                isOpened={selected === settlement.id}
                onDetailsClick={() => onDetailsClick(settlement)} // Вот исправление
              />
            </React.Fragment>
          )
        })}
