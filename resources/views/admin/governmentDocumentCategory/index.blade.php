      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="mb-2 d-flex justify-content-between">
            <div>
              <h2>Категории документов правительства</h2>
            </div>

            <div>
              <a href="{{route('admin.governmentDocumentCategorys.create')}}">
                  ...
                  @if(isset($categories))
                    @foreach($categories as $category)
                      <tr role="row" class="odd">
                        ...
                        <td style="">
                          <div class="btn-group">
                            <a href="{{route('admin.governmentDocumentCategorys.edit', $category->id)}}"
