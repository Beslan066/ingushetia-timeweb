      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="mb-2 d-flex justify-content-between">
            <div>
              <h2>Документы правительства</h2>
            </div>

            <div>
              <a href="{{route('admin.governmentDocuments.create')}}">
                      ...
                      <tr role="row" class="odd">
                        ...
                        <td style="">
                          <div class="btn-group">
                            ...
                            <a href="{{route('admin.governmentDocuments.edit', $item->id)}}"
                               class="btn btn-outline-primary waves-effect waves-light">Редактировать</a>
                            <form action="{{route('admin.governmentDocuments.delete', $item->id)}}" method="post">
                              @csrf
                              @method('destroy')
