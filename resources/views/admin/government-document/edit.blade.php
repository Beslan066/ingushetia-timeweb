    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{route('admin.governmentDocuments.update', $document->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="card-body">
                        <div>
                        ...
                        <div class="form-group w-50">
                            ...
                            <select class="form-control" id="exampleFormControlSelect1" name="government_document_category_id">
