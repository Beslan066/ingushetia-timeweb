          ...
          <div class="card-body">
            ...
            <div class="form-group w-50">
              ...
              <input class="form-control form-control-lg mb-3" type="text"
                     placeholder="Введите название региона" name="name" id="name" 
            ...
            <div class="form-group w-50">
              ...
              <textarea class="form-control summernote"
                        ...
                        name="description" id="description">{{ old('description', $region->description) }}</textarea>
              @error('description')
              <div class="text-danger">{{ $message }}</div>
              @enderror
            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <input type="file" class="dropify" data-height="300" name="image_main" multiple
                                                   @if($region->image_main)
                                                       data-default-file="{{ asset('storage/' . $region->image_main) }}"
                                                @endif
                                            />
            ...
            <div id="sections-container">
              @foreach($region->sections as $index => $section)
...
@push('scripts')
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      let sectionCount = {{ count($region->sections) }};
