    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{route('admin.federalAuthorities.update', $federalAuthority->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="card-body">
                        <div>
                            <div class="form-group w-50">
                                ...
                                <input class="form-control form-control-lg mb-3" type="text" placeholder="Введите заголовок" name="title" value="{{$federalAuthority->title}}">
                            </div>
                            @error('title')
                            ...
                            <div class="form-group w-50">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlTextarea1"  style="height: 101px;"
                                       placeholder="Вставьте ссылку" name="link"  value="{{$federalAuthority->link}}"/>
                            </div>
                            @error('lead')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
