      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="mb-2 d-flex justify-content-between">
            <div>
              <h2>Администрация Главы правительства</h2>
            </div>
                  ...
                  @if(isset($administrations))
                    @foreach($administrations as $item)
                      <tr role="row" class="odd">
                        ...
                        <td style="">
                          <div class="btn-group">
                            <a href="{{route('admin.administrations.edit', $item->id)}}"
                               class="btn btn-outline-primary waves-effect waves-light">Редактировать</a>
                            <form action="{{route('admin.administrations.delete', $item->id)}}" method="post">
                              @csrf
                              @method('delete')
