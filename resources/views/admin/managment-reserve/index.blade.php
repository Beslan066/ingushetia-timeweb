              ...
              <div class="col-sm-12">
                <table id="selection-datatable"
                  ...
                  <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="selection-datatable" rowspan="1" colspan="1"
                        style="width: 394px;" aria-label="Position: activate to sort column ascending">Тип
                    </th>
                    <th class="sorting" tabindex="0" aria-controls="selection-datatable" rowspan="1" colspan="1"
                        style="width: 394px;" aria-label="Position: activate to sort column ascending">Файл
                    </th>
                  ...
                  @if(isset($managmentReserves))
                    @foreach($managmentReserves as $item)
                      <tr role="row" class="odd">
                        ...
                        <td style="">
                          <div class="btn-group">
                            <a href="{{route('admin.managmentReserves.edit', $item->id)}}"
